  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justified-center flex-wrap">
          <motion.a
    ...
    bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32"
        >
          <nav className="flex items-center flex-col justify-center">
            <CustomMobileLink href="/" title="Home" toggle={clickHandler} />
            <CustomMobileLink
              href="/about"
              title="About"
              toggle={clickHandler}
          ...
          <nav className="flex items-center justified-center flex-wrap mt-2">
            <motion.a
              href="https://twitter.com"
              target={"_blank"}
              whileHover={{ y: -2 }}
